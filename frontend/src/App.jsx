      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10">
          ...
          <Routes>
            ...
            <Route path="/offline-learning" element={<ProtectedRoute><OfflineLearning /></ProtectedRoute>} />
            <Route path="/teacher-dashboard" element={<ProtectedRoute><TeacherDashboard /></ProtectedRoute>} />
            <Route path="/institution-dashboard" element={<ProtectedRoute><TeacherDashboard /></ProtectedRoute>} />
            <Route path="/career-readiness" element={<ProtectedRoute><CareerReadiness /></ProtectedRoute>} />
            <Route path="/placement-readiness" element={<ProtectedRoute><PlacementPrediction /></ProtectedRoute>} />
            <Route path="/test" element={<ProtectedRoute><TestPage /></ProtectedRoute>} />
            <Route path="/assessment" element={<ProtectedRoute><TestPage /></ProtectedRoute>} />
